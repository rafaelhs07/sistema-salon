            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <label className="text-xs font-semibold text-[#66756E]">
                    ...
                    <input
                        ...
                        className="mt-1 h-11 w-full rounded-xl border border-[#DCE5E0] bg-white px-3 text-sm outline-none focus:border-[#6F8F83]"
                    />
                </label>
        ...
        <article className="rounded-[26px] border border-[#DCE5E0] bg-white p-5 shadow-[0_12px_35px_rgba(36,48,44,0.07)]">
            <div className="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p className="mt-3 text-xl font-bold text-[#26332F]">
                        {valorA}
                    </p>
                        ...
                        return (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-1 font-bold text-[#26332F]">
                                        {
                                            item.valor
                                        }
                                    </p>
